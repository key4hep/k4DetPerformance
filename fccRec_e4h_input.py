...
evtsvc.input = 'dummyInput_edm4hep.root' 
...
InitDD4hep.Parameters = {
                         "DD4hepXMLFile": [os.environ["LCGEO"]+"/FCCee/compact/FCCee_o2_v02/FCCee_o2_v02.xml"],
...
# ==== calorimeter digitisation and pandora reco ====
...
###algList.append(LumiCalReco)  #  *** Break *** segmentation violation 
                                #  Error in <TTree::SetBranchAddress>: unknown branch -> LumiCalClusters
