...
InitDD4hep.Parameters = {
                         "DD4hepXMLFile": [os.environ["LCGEO"] + DetectorModel],
...
VXDBarrelDigitiser.Parameters = {
                                 "IsStrip": ["false"],
                                 "ResolutionU": [VXDBarrelResU, VXDBarrelResU, VXDBarrelResU, VXDBarrelResU, VXDBarrelResU, VXDBarrelResU],
                                 "ResolutionV": [VXDBarrelResV, VXDBarrelResV, VXDBarrelResV, VXDBarrelResV, VXDBarrelResV, VXDBarrelResV],
...
VXDEndcapDigitiser.Parameters = {
                                 "IsStrip": ["false"],
                                 "ResolutionU": [VXDEndcapResU, VXDEndcapResU, VXDEndcapResU, VXDEndcapResU, VXDEndcapResU, VXDEndcapResU],
                                 "ResolutionV": [VXDEndcapResV, VXDEndcapResV, VXDEndcapResV, VXDEndcapResV, VXDEndcapResV, VXDEndcapResV],
...
InnerPlanarDigiProcessor.Parameters = {
                                       "IsStrip": ["false"],
                                       "ResolutionU": [ITBarrelResU],
                                       "ResolutionV": [ITBarrelResV],
...
InnerEndcapPlanarDigiProcessor.Parameters = {
                                             "IsStrip": ["false"],
                                             "ResolutionU": ["0.005", ITEndcapResU, ITEndcapResU, ITEndcapResU, ITEndcapResU, ITEndcapResU, ITEndcapResU],
                                             "ResolutionV": ["0.005", ITEndcapResV, ITEndcapResV, ITEndcapResV, ITEndcapResV, ITEndcapResV, ITEndcapResV],
...
OuterPlanarDigiProcessor.Parameters = {
                                       "IsStrip": ["false"],
                                       "ResolutionU": [OTBarrelResU, OTBarrelResU, OTBarrelResU],
                                       "ResolutionV": [OTBarrelResV, OTBarrelResV, OTBarrelResV],
...
OuterEndcapPlanarDigiProcessor.Parameters = {
                                             "IsStrip": ["false"],
                                             "ResolutionU": [OTEndcapResU, OTEndcapResU, OTEndcapResU, OTEndcapResU, OTEndcapResU],
                                             "ResolutionV": [OTEndcapResV, OTEndcapResV, OTEndcapResV, OTEndcapResV, OTEndcapResV],
